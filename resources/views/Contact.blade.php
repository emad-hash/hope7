            ...
            <div class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div
                        ...
                        <h6 class="mb-0">Macca Street, Amman, Jordan</h6>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div
                    ...
                    <div class="bg-white rounded p-5 m-5 mb-0">
                        <form action="/Contact" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control bg-light border-0" rows="5" placeholder="Message"
